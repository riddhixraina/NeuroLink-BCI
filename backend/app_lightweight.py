"""
Lightweight Flask Backend for Railway Deployment
This version uses mock data instead of PyTorch to stay within size limits
"""
...
def handle_start_streaming():
    ...
    # Streaming is handled by the background thread
